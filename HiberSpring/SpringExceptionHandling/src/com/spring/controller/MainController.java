...
public class MainController {
	...
	public String cidUpdate(
		...
		try {
			...
			CustomerCommand customerCommand = new CustomerCommand(to.getCid()
					...
					to.getAge() + "");
			model.put("customerCommand", customerCommand);
			httpSession.setAttribute("customerCommand", customerCommand);
	...
	public String updateSubmit(
		...
		CustomerCommand customer = (CustomerCommand) httpSession
				.getAttribute("customerCommand");
		CustomerTO to = new CustomerTO(Integer.parseInt(customer.getCid()),
				customerCommand.getCname(), customerCommand.getEmail(),
				customerCommand.getPhone(), Integer.parseInt(customerCommand
						.getAge()));
