...
/**
 * Here we are making ConnectionFactory as a singleton. Since we want connection
 * factory to be initiated once and used by different classes of the project.
 * 
 * We also want to read the connection parameters once and use it as a place
 * holder for pooled connections.
 * 
