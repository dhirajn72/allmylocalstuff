...
/**
 * @author AnkitMittal Copyright (c) JavaMadeSoEasy.com , AnkitMittal . All
 *         Contents are copyrighted and must not be reproduced in any form. This
 *         class provides custom implementation of ArrayList(without using java
 *         api's) Insertion order of objects is maintained. Implementation
 *         allows you to store null as well.
 * @param <E>
 */
 ...
 * OUTPUT
 * 
 * Displaying list : 1 2 3 4 1 2 element at index in custom ArrayList > 1 = 2
 * element removed from index 1 = 2
 * 
 * let's display custom ArrayList again after removal at index 1 Displaying list
 * : 1 3 4 1 2
 */
