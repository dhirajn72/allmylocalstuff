...
public class GetEmployeeByID extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request,
		...
		SessionFactory sessionFactory = (SessionFactory) request
				.getServletContext().getAttribute("SessionFactory");
		logger.info("Here is the session factory object: "+sessionFactory);
		...
		if (emp != null) {
			...
			out.print("<html><body><h2>No Employee Found with ID=" + empId
					+ "</h2></body></html>");
		}
	}
